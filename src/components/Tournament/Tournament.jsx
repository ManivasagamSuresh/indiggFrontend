  ...
  return (
    ...
    <div className="flex flex-col gap-4 h-fit items-center italic  bgcard">
      <div className="w-full flex flex-col items-center ">
        ...
        <div className="absolute top-44  h-fit w-72  text-lg font-semibold italic skew-x-12 px-2 text-center left-auto right-auto bgcard boxshadowgray md:top-96 md:h-14 md:px-9 md:text-3xl">
            {event.name}
        </div>
      </div>
