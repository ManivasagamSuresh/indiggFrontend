    ...
    <div className='bg-gradient-to-b from-sky-400 to-violet-600 h-fit w-screen flex flex-col md:flex-col md:bg-gradient-to-b'>
        <div className='flex-1'>
           <Navbar home={false}/>
            ...
            <h1 className='text-xl md:text-3xl font-times font-extrabold text-center bg-gradient-to-r from-grad-start via-grad-mid to-grad-end text-transparent bg-clip-text text-custom-shadow italic my-4'>Join your favorite Tournament here</h1>
            </div>   
        </div>
